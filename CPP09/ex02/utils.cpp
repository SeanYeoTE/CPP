...
template <typename T>
void PmergeMe<T>::printpairs(const std::vector<int> &pairs, int depth,
                             int size) {
...
template int PmergeMe<std::vector<int> >::binarySearch<std::vector<int> >(
    int, int, int, const std::vector<int> &);
template int PmergeMe<std::deque<int> >::binarySearch<std::vector<int> >(
    int, int, int, const std::vector<int> &);
template int PmergeMe<std::deque<int> >::binarySearch<std::deque<int> >(
    int, int, int, const std::deque<int> &);
