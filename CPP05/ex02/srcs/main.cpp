...
int	main(void)
{
	...
	std::cout << YELLOW << "=== Test RobotomyRequestForm Constructor and Destructor ===" << RESET << std::endl;
	try
	{
		RobotomyRequestForm form1("RobotLab");
		std::cout << GREEN << "Form created: " << form1 << RESET << std::endl;
	}
	catch (const std::exception &e)
	{
	...
	std::cout << YELLOW << "=== Test RobotomyRequestForm Copy Constructor and Assignment Operator ===" << RESET << std::endl;
	try
	{
		RobotomyRequestForm form1("Factory");
		RobotomyRequestForm form2 = form1; // Copy constructor
		RobotomyRequestForm form3("Temp");
		form3 = form1; // Assignment operator
		std::cout << GREEN << "Copied form: " << form2 << RESET << std::endl;
		std::cout << GREEN << "Assigned form: " << form3 << RESET << std::endl;
	}
